...
module.exports = function(connect) {
  ...
  function MongoStore(options) {
    ...
    function initWithMongojsConnection() {
      self.db = options.db;
      connectionReady(); // We can start right away, no need to wait
    }
    ...
    } else if (options.mongojsConnection){ 
      debug('use strategy: `native_db`');
      process.nextTick(initWithMongojsConnection);
    } else {
